            ...
            <div className="relative rounded-2xl border border-white/10 bg-[rgba(10,8,16,0.6)] backdrop-blur-xl p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                ...
                <div className="relative mb-3" ref={dropdownRef}>
                    ...
                    >
                        ...
                        <svg className="h-4 w-4 opacity-70" viewBox="0 0 20 20" fill="currentColor"><path d="M5.23 7.21a.75.75 0 011.06.02L10 10.94l3.71-3.71a.75.75 0 111.08 1.04l-4.25 4.25a.75.75 0 01-1.06 0L5.21 8.27a.75.75 0 01.02-1.06z" /></svg>
                    </button>
                    ...
                    <AnimatePresence>
                        {isDropdownOpen && (
                            <motion.div
                                ...
                                className="absolute z-20 mt-2 w-full overflow-hidden rounded-xl border border-white/10 bg-[#141126] shadow-2xl"
                                role="listbox"
                            >
                ...
                {!isEditingVillain ? (
                    <button
                        ...
                        className={`w-full rounded-xl px-4 py-2.5 text-sm transition border ${villain ? "border-purple-500/40 bg-purple-700/20 hover:bg-purple-700/30" : "border-white/10 bg-white/5 hover:bg-white/10"} text-white`}
            ...
            <section className="px-4 py-14 sm:py-16">
                ...
                >
                    {guests.map((guest, idx) => (
                        <motion.div variants={fadeIn(0.03 * (idx % 10))} key={guest.id}>
                            <GuestCard
                                id={guest.id}
                                name={guest.Name}
                                status={guest.Status}
